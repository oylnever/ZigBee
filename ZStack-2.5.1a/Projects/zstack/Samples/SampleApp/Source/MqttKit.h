...
enum MqttPacketType
{
    ...
    MQTT_PKT_CONNECT = 1, /**< 1连接请求数据包 */
    MQTT_PKT_CONNACK,     /**< 2连接确认数据包 */
    MQTT_PKT_PUBLISH,     /**< 3发布数据数据包 */
    MQTT_PKT_PUBACK,      /**< 4发布确认数据包 */
    MQTT_PKT_PUBREC,      /**< 5发布数据已接收数据包，Qos 2时，回复MQTT_PKT_PUBLISH */
    MQTT_PKT_PUBREL,      /**< 6发布数据释放数据包， Qos 2时，回复MQTT_PKT_PUBREC */
    MQTT_PKT_PUBCOMP,     /**< 7发布完成数据包， Qos 2时，回复MQTT_PKT_PUBREL */
    MQTT_PKT_SUBSCRIBE,   /**< 8订阅数据包 */
    MQTT_PKT_SUBACK,      /**< 9订阅确认数据包 */
